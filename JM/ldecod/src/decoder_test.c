 ...
 ***********************************************************************
 */
struct mv_linklist *mvlist; //a global Linked List variable storing motion vectors
int main(int argc, char **argv)
{
  ...
  mvlist=(struct mv_linklist *)malloc(sizeof(struct mv_linklist));
  mvlist->head=NULL;mvlist->length=0;
